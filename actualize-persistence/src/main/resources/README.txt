...
<generatorConfiguration>
    ...
    <context id="default" targetRuntime="MyBatis3">
        ...
        -->
        <javaModelGenerator targetPackage="cn.bidlink.datacenter.actualize.model" targetProject="src/main/java">
            <!-- 是否对model添加 构造函数 -->
        ...
        -->
        <javaClientGenerator targetPackage="cn.bidlink.datacenter.actualize.mapper" targetProject="src/main/java" type="XMLMAPPER">
