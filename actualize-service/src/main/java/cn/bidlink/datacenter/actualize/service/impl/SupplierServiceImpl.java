...
import cn.bidlink.datacenter.actualize.model.*;
import cn.bidlink.datacenter.actualize.persistence.dao.*;
...
public class SupplierServiceImpl implements SupplierService {
    ...
    public List<TRegUser> findByCondition(Long companyId) {
        ...
        if (!byCondition.getSuccess()) {
            log.error("{}调用{}时发生未知异常,error Message:{}", "cn.bidlink.datacenter.actualize.controller.CorpExportController.test",
        ...
        if (result == null) {
            log.warn("cn.bidlink.datacenter.actualize.controller.CorpExportController.test时未获取到结果");
        }
        return result;
    }
